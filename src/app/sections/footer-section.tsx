...
export const FooterSection = () => {
    ...
    const EMAIL = "andargiehermela1@gmail.com";
    ...
    const socials: { name: string, link: string, icon: JSX.Element }[] = [
        {
            ...
            name: "LinkedIn",
            link: "https://www.linkedin.com/in/hermela-andargie-793027330/",
        },
        {
            icon: <IconBrandGithub size={30} />,
            name: "GitHub",
            link: "https://github.com/Hermi-git",
        },
        {
            icon: <IconBrandTelegram size={30} />,
            name: "Telegram",
            link: "https://t.me/Hermiand",
        },
        {
            icon: <IconBrandLeetcode size={30} />,
            name: "Leetcode",
            link: "https://leetcode.com/u/Hermela_Andargie/",
        },
        {
            icon: <IconCodeforce />,
            name: "Codeforces",
            link: "https://codeforces.com/profile/Hermela_Andargie",
        }
    ];
    ...
    return (
        <div className="flex flex-col gap-2 mb-14 md:m-0 ">
                    ...
                    <div className="h-full w-full rounded-md flex flex-col flex-wrap items-center px-5 justify-evenly gap-3">
                        ...
                        <div className="flex items-center justify-start md:justify-center w-full text-nowrap">
                            <span className="inline font-semibold">
                                ...
                                <Link href={"https://github.com/HermelaAndargie/"} className="hover:underline" target="_blank">Hermela</Link>
                            </span>
                        </div>
            ...
            <section className="text-xs text-center md:text-start">
                &copy; {new Date().getFullYear()} Hermela Andargie. All rights reserved.
            </section>
        </div>
    );
};
